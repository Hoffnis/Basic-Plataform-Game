...
import com.hoffnisgames.entities.Moeda;
			...
			for(int xx = 0; xx < map.getWidth(); xx++ ) {
				for(int yy = 0; yy < map.getHeight(); yy++) {
					...
					if(pixelAtual == 0xFF000000) {
						...
						Enemy1 enemy = new Enemy1(xx*16, yy*16, 16,16, 1,Entity.ENEMY1);
						Game.entities.add(enemy);
					} else if(pixelAtual == 0xFFFFE500) {
						Moeda moeda = new Moeda(xx*16, yy*16,16,16,1,Game.spritesheet.getSprite(0, 32, 16, 16));
